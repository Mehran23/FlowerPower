...
@section('content')
    <div class="bg-yellow-100 h-screen flex items-center">
        <div class="bg-yellow-50 mx-auto my-8 px-10 py-16 border border-black rounded-lg">
            <h1 class="text-3xl font-bold tracking-tight text-gray-900">Medewerker Toevoegen</h1>
            ...
            <div class="mt-6">
                <form method="POST" action="{{ route('employee.store') }}">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="password" name="password" id="password" minlength="8" class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" required>
                    </div>
