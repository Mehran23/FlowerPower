<x-guest-layout>
    <form method="POST" class="mx-auto max-w-lg bg-yellow-50 border border-black rounded-lg py-5 px-5" action="{{ route('register') }}">
    @csrf
    ...
    <div class="grid grid-cols-2 gap-4">
        ...
        <div>
            ...
            <x-text-input id="phone_number" class="w-full" type="tel" name="phone_number" :value="old('phone_number')" required autocomplete="tel" />
